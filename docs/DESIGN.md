...
> Design notes for **game-moderation-sms-dispatcher** — a runnable typescript example that Typed Node service that alerts game moderators when player assets or live queues need immediate attention.
...
- **Feature code** — the actual task: game-moderation-alerts.
